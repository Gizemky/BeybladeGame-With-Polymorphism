...
public Drayga(String beyblade_gamer_name, int rotational_speed, int attack_strength,String sacred_beast) {
...
public void sacred_beast() {
	...
	System.out.println(getBeyblade_gamer_name() + " 's Attack : Lion's Claw ");
